...
public class TestExample {
    ...
    private static final String XML_FILE = "C:\\Users\\Ulyana\\Desktop\\веб\\веб\\Project3\\JAXB_\\dept-info.xml";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            JAXBContext context = JAXBContext.newInstance(jaxb.model.Department.class);
